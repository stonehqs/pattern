package com.hqs.pattern.config;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        ...
        docket
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.hqs.pattern.controller"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Spring boot strategy factory pattern")
                .description("Springboot 策略工厂模式")
